...
class Employee:
    def __init__(self, root):
        ...
        self.EmployeeTable = ttk.Treeview(TableFrame, column=("dep", "name", "degi", "dob", "doj", "email", "address", "gender", "phone","marriedstatus", "salary", "country", "idproof", "idproofcomb"  ), xscrollcommand=ScrollX.set, yscrollcommand=ScrollY.set)
    ...
    def GetCursor(self, event=""):
        ...
        self.DOBVariable.set(data[3])
        self.DOJVariable.set(data[4])
        self.EmailVariable.set(data[5])
        self.AddressVariable.set(data[6])
        self.GenderVariable.set(data[7])
        self.PhoneVariable.set(data[8])
        self.MarriedVariable.set(data[9])
        self.SalaryVariable.set(data[10])
        self.CountryVariable.set(data[11])
        self.IDProofVariable.set(data[12])
        self.IDProofComboVariable.set(data[13])
